...
public class MySQL extends Database {
    ...
    public MySQL(JavaPlugin plugin, final Logger log, final String host, final int port, final String user, final String pass, final String database) {
        super(plugin, log, "[MySQL] ");
        this.host = host;
        this.port = port;
        this.user = user;
        this.pass = pass;
    ...
    public MySQL(JavaPlugin plugin, final Logger log, final String user, final String pass, final String database) {
        super(plugin, log, "[MySQL] ");
        this.user = user;
        this.pass = pass;
        this.database = database;
